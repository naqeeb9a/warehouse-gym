...
class GymDetail extends StatefulWidget {
  String name;
  dynamic image;
  GymDetail({ required this.name , required this.image,Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  children: [
                    bar(context, true,
                        centerCheck: true, centerText: widget.name, back: true),
                    ...
                    text(
                        context,
                        "Productivity is at an all-time high in the busy streets of ${widget.name.toLowerCase()}, brimming with industrialists and businessmen. The Warehouse Gym at ${widget.name.toLowerCase()} stands out, with its graffiti-clad walls and highly energetic atmosphere among the industrialised setting. An ideal place for hustlers to let off steam and significantly elevate their ability to focus.",
                        0.04,
                        myWhite),
